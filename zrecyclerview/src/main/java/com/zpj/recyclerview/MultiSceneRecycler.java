...
//
//public class MultiSceneRecycler extends BaseRecycler<MultiData<?>, MultiSceneRecycler> {
//
...
//    }
//
//    public MultiSceneRecycler(@NonNull RecyclerView recyclerView, @NonNull List<MultiData<?>> dataSet) {
...
//    }
//
//    public static MultiSceneRecycler with(@NonNull RecyclerView recyclerView, @NonNull List<MultiData<?>> dataSet) {
